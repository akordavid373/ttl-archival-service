  ...
  useEffect(() => {
    ...
    if (notification.autoDismiss && notification.dismissTimeout) {
      ...
      const interval = setInterval(() => {
        ...
        const remaining = Math.max(0, 100 - (elapsed / notification.dismissTimeout!) * 100)
  ...
  return (
    ...
    >
      ...
      <div className='flex-1 min-w-0'>
        ...
        <p className='text-sm mt-1 opacity-90 break-words'>{notification.message}</p>
        ...
        {notification.autoDismiss && notification.dismissTimeout && (
          <div className='absolute bottom-0 left-0 h-1 bg-current opacity-20 rounded-b-lg transition-all duration-100'
