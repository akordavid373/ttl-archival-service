    ...
    try {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        const mockArchives: ArchiveEntry[] = [
          { id: '1', filename: 'user_logs_2024_03_21.sql', size: 14200000, size_formatted: '14.2 MB', created_at: new Date(Date.now() - 3600000 * 2).toISOString(), status: 'Verified', checksum: 'abc...' },
          { id: '2', filename: 'audit_trail_march.json', size: 2100000, size_formatted: '2.1 MB', created_at: new Date(Date.now() - 3600000 * 5).toISOString(), status: 'Archived', checksum: 'def...' },
          { id: '3', filename: 'system_metrics_daily.csv', size: 850000, size_formatted: '850 KB', created_at: new Date(Date.now() - 3600000 * 24).toISOString(), status: 'Verified', checksum: 'ghi...' },
          { id: '4', filename: 'error_logs_q1.zip', size: 45000000, size_formatted: '45.0 MB', created_at: new Date(Date.now() - 3600000 * 48).toISOString(), status: 'Expiring', checksum: 'jkl...' },
        ];
        setStats(mockStats);
