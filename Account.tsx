    ...
    >
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Update your account password. After saving, you may be logged out.
        </p>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-6">
          ...
          >
            <input
              ...
              className="w-full bg-accent/40 border border-border/40 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
            />
          </FormField>
          ...
          <div className="flex justify-end gap-4 pt-4">
            <button
              ...
              className="px-4 py-2 text-sm font-bold text-muted-foreground disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-6 py-2 bg-primary text-primary-foreground font-bold text-sm rounded-xl disabled:opacity-50"
            >
      ...
      <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
        ...
        <div className="flex items-center gap-6 mb-8 pt-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground font-medium">
              System Administrator • Since Jan 2024
            </p>
            <button
              type="button"
        ...
        <div className="pt-8 mt-8 border-t border-border/40 flex flex-col gap-4">
          <button
            ...
            className="text-sm font-semibold flex items-center gap-2 text-primary hover:underline w-fit"
          >
          ...
          <button
            type="button"
            className="text-sm font-semibold flex items-center gap-2 text-rose-500 hover:underline w-fit"
          >
