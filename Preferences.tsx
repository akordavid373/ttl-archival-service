  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
      <SectionTitle
        ...
        icon={Globe}
        description="System-level settings and regional defaults."
      />
      ...
      <div className="p-4 rounded-2xl bg-primary/5 border border-primary/10 flex gap-4 mt-8">
        ...
        <p className="text-xs text-primary/80 leading-relaxed font-medium">
          Changing language and timezone will affect timestamp generation and
          verification reports across the application.
        </p>
      </div>
    </div>
  );
