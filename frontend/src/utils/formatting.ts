...
const currencyFormatOptions: Record<SupportedLanguage, Intl.NumberFormatOptions> = {
  en: {
    style: 'currency',
    currency: 'USD',
...
export const formatNumber = (
  ...
  return new Intl.NumberFormat(dateLocales[locale], formatOptions).format(value)
}
