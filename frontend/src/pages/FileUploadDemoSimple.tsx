      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Comprehensive file upload solutions with drag-and-drop, progress
            tracking, validation, and preview functionality.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-sm text-slate-600">
              Intuitive drag-and-drop interface with visual feedback and
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-sm text-slate-600">
              File type and size validation with customizable rules and clear
              error messages.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-sm text-slate-600">
              Image previews, file icons, and detailed information for each
              uploaded file.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b">
              ...
              <p className="text-slate-600 mt-1">
                Full-featured upload component with pause/resume, retry,
        ...
        {uploadedFiles.length > 0 && (
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="p-6 border-b">
              ...
              <p className="text-slate-600 mt-1">Recently uploaded files</p>
            </div>
            <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            ...
            <p className="text-slate-600 mt-1">
              Available props and customization options for the upload
              components
            </p>
          </div>
          <div className="p-6">
