...
export default function ToastDemo() {
  const { addNotification, preferences, updatePreferences } =
    useNotifications();
  const [selectedType, setSelectedType] = useState<NotificationType>("info");
  const [selectedPriority, setSelectedPriority] =
    useState<NotificationPriority>("medium");
  ...
  const showCustomNotification = () => {
    addNotification({
      ...
      dismissTimeout: preferences.autoDismiss
        ? preferences.defaultTimeout
        : undefined,
    });
  };
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">
          Explore the comprehensive toast notification system with multiple
          types, positions, and features.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-2">
            {(
              ["low", "medium", "high", "urgent"] as NotificationPriority[]
            ).map((priority) => (
              <button
                key={priority}
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {(["low", "medium", "high", "urgent"] as NotificationPriority[]).map(
            (priority) => (
              <button
                key={priority}
        ...
        <p className="text-sm text-gray-600">
          Notice how urgent notifications have stronger visual indicators and
          don't auto-dismiss.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() =>
                updatePreferences({ autoDismiss: !preferences.autoDismiss })
              }
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
          ...
          <div className="flex items-center justify-between">
            ...
            <select
              ...
              onChange={(e) =>
                updatePreferences({ defaultTimeout: Number(e.target.value) })
              }
