  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Media Components Demo</h1>
          <p className="text-gray-600">Showcase of custom media player and date range picker components</p>
        </div>

        {/* Audio Player Section */}
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Audio Player with Playlist</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Video Player with Subtitles</h2>
          <div className="bg-white rounded-lg shadow-md p-6">
            <VideoPlayer
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Advanced Date Range Picker</h2>
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="max-w-md">
              ...
              {dateRange.start && dateRange.end && (
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-medium text-gray-900 mb-2">Selected Range:</h3>
                  ...
                  <p className="text-sm text-gray-600">
                    Duration: {Math.abs(dateRange.end.getTime() - dateRange.start.getTime()) / (1000 * 60 * 60 * 24)} days
                  </p>
                </div>
              )}
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="font-semibold text-gray-900 mb-3">Date Range Picker</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-green-500 rounded-full mr-2"></span>
                  Preset date ranges
