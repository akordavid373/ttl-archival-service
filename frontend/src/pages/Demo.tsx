    ...
    <div className="p-8 max-w-4xl mx-auto space-y-12">
      <section>
        <h2 className="text-2xl font-bold mb-4">
          #149 A/B Testing & #151 Analytics
        </h2>
        <div className="p-6 border rounded-xl bg-white shadow-sm">
          <p className="mb-4">
            Current CTA Variant:{" "}
            <span className="font-mono font-bold">{ctaVariant}</span>
          </p>
          <button
            onClick={() =>
              trackClick("A/B Test CTA Click", { variant: ctaVariant })
            }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <p className="mb-2 text-sm text-gray-500">
              Standard Optimized Image (Lazy, Blur-up)
            </p>
            <OptimizedImage
        ...
        {wizardComplete ? (
          <div className="p-12 text-center bg-green-50 rounded-xl border border-green-200">
            ...
            <p className="text-green-700">
              Check your localStorage (key: 'demo-wizard') to see the persisted
              data.
            </p>
            <button
