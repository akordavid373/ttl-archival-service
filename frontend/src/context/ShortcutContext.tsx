...
export const ShortcutProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const shortcuts: Shortcut[] = [
    { key: 'ctrl+k', description: 'Command Palette', action: () => console.log('Palette'), category: 'Actions' },
    { key: '?', description: 'Show Help', action: () => setHelpOpen(prev => !prev), category: 'View' },
    { key: 'g d', description: 'Go to Dashboard', action: () => navigate('/'), category: 'Navigation' },
    { key: 'g p', description: 'Go to Policies', action: () => navigate('/policies'), category: 'Navigation' },
    { key: 'g a', description: 'Go to Archives', action: () => navigate('/archives'), category: 'Navigation' },
    { key: 'g b', description: 'Go to Blockchain', action: () => navigate('/blockchain'), category: 'Navigation' },
