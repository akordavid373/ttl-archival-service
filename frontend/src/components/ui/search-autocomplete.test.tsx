...
describe('SearchAutocomplete', () => {
  const mockSuggestions: SearchSuggestion[] = [
    { id: '1', label: 'Apple iPhone', value: 'Apple iPhone', description: 'Latest smartphone' },
    { id: '2', label: 'Apple MacBook', value: 'Apple MacBook', description: 'Professional laptop' },
    { id: '3', label: 'Apple iPad', value: 'Apple iPad', description: 'Tablet device' },
  ]
  ...
  it('closes dropdown when input loses focus', async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByRole('list')).not.toBeInTheDocument()
    }, { timeout: 200 }) // Account for the 150ms delay
  })
