...
export function NotificationPreferences({
  ...
  const [activeTab, setActiveTab] = useState<
    "preferences" | "history" | "quiet_hours"
  >("preferences");
  ...
  const frequencies = [
    {
      id: "immediate",
      label: "Immediate",
      description: "Send as soon as event occurs",
    },
    {
      id: "hourly",
      label: "Hourly",
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <div className={cn("p-2 rounded-lg bg-accent/50")}>
                        <category.icon
                          className={cn(
                            "h-5 w-5 text-" + category.color + "-500",
                          )}
                        />
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-accent/30 rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    <strong>Current quiet hours:</strong> {quietHours.start} -{" "}
                    {quietHours.end} ({quietHours.timezone})
