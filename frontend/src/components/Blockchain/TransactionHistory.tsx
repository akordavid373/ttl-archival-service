          ...
          {isLoading && transactions.length === 0 ? (
            <div className="space-y-4">
              {Array(5)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="h-20 bg-accent/10 rounded-2xl animate-pulse"
                  ></div>
                ))}
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center space-y-4">
              ...
              <p className="text-sm font-bold text-muted-foreground opacity-60">
                No recent on-chain activity detected.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <p className="text-[10px] font-extrabold text-muted-foreground uppercase tracking-widest leading-none shrink-0 truncate">
                          {tx.type}
                        </p>
                        <span className="h-1 w-1 bg-border/60 rounded-full shrink-0"></span>
                        <p className="text-[10px] text-muted-foreground font-medium shrink-0 italic">
                          {tx.created_at}
                        </p>
                      </div>
                  ...
                  <div className="flex items-center gap-6 shrink-0">
                    <div className="hidden md:flex flex-col items-end">
                      <span className="text-[10px] font-bold text-muted-foreground uppercase leading-none mb-1 shrink-0">
                        Fee Charged
                      </span>
                      <span className="text-xs font-mono font-bold leading-none shrink-0">
                        {tx.fee}{" "}
              ...
              <div className="pt-8 border-t border-border/20 flex items-center justify-center">
                <p className="text-xs text-muted-foreground font-medium italic">
                  Displaying latest entries anchored on the Stellar Distributed
                  Ledger.
                </p>
              </div>
            </div>
